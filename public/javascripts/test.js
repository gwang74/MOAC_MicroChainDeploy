...
function getVnodeInfo() {
    ...
    let config = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../../contract.json"), 'utf8'));
    let subchainaddr = config['microChainAddr'];
    SubChainBase = subchainbaseContract.at(subchainaddr);
    var balance = SubChainBase.BALANCE();
    // var info = SubChainBase.getVnodeInfo.call();
    console.log(balance.toString());
    // console.log(info);
}

function scs() {
    var res = utils.waitBlockForTransactionInMicroChain('0x32231dd017075bb997f27bde90a14d80829e9ab0', '0xbf9b209f8ae1fac81e7012972ac68f77ddff58b7b2b03dd17dca7b127c51a04a');
    // var res = utils.chain3.scs.getTransaction('0x32231dd017075bb997f27bde90a14d80829e9ab0', '0x9ee5f109777e71ab43f21199aae769250c6af6ef03a15fa46b5a829d25938834');
    console.log(res)
}