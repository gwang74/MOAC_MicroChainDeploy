...
async function deploy(req, result, next) {
    ...
    var needMoac = Number(scs.length * minScsDeposit) + Number(scs.length * 1) + Number(vnode.length * minVnodeDeposit) + Number(vnode.length * 1) + Number(microChainDeposit) + 1;
